...
interface MoveOriginDAO {
    ...
    @Query("select * from moveOrigin_tb where (endSide = :endSide or endSide = :mirrorEndSide) and canHand = 1")
    suspend fun getHandMoveByEndWithMirror(endSide: StandSide,mirrorEndSide: StandSide) :List<MoveOrigin>
